...
const ImagePreview = (props) => {
    return(
        <div className='mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl mx-auto'>
            {/* Origanal Image */}
            <div className="bg-white shadow-lg rounded-xl overflow-hidden">
                ...
                (<div className="flex item-center justify-center h-80 bg-gray-200">No Image Selected</div>)}
            </div>
            ...
            <div className="bg-white shadow-lg rounded-xl overflow-hidden">
                ...
                {props.loading ? (
                    ...
                    <div className="flex item-center justify-center h-80 bg-gray-200">
                        No Enhanced Image
                    </div>
                )}
            </div>
